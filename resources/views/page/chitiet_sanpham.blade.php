					...
					<div class="row">
						...
						<div class="col-sm-8">
							<div class="single-item-body">
								<p class="single-item-title"><h2>{{$sanpham->name}}</p>
							...
							<div class="single-item-options">
								<form action="add-to-cart-qty" method="POST" id="themgiohang_sl">
									<input type="hidden" name="_token" value="{{csrf_token()}}"/>
									<select class="wc-select" name="select" id="change">
									...
									<input type="hidden" name="id" value="{{$sanpham->id}}"> 
	 								<a class="add-to-cart" onclick="document.getElementById('themgiohang_sl').submit()"><i class="fa fa-shopping-cart"></i></a>
