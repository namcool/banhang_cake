	...
	<div class="container">
		<div id="content">
			<form action="{{route('thanhtoan')}}" method="post" class="beta-form-checkout">
				...
				<div class="row" style="color:green;      font-size:18pt;      font-style:bold;">@if(Session::has('thongbao')){{Session::get('thongbao')}}@endif</div>
				<div class="row">
					<div class="col-sm-6">
						<h4>Đặt hàng</h4>
						...
						<div class="your-order">
							...
							@if(Session::has('cart'))
								...
								<div class="your-order-item">
									...
									<!--  one item	 -->
										<div class="media">
											<img width="25%" height="25%" src="source/image/product/{{$product['item']['image']}}" alt="" class="pull-left">
